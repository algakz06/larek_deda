...
class Contract(Base):
    ...
    customer_inn = mapped_column(
        "customer_inn", VARCHAR(15), nullable=True
    )
    ...
    supplier_inn = mapped_column(
        "supplier_inn", VARCHAR(15), nullable=True
    )
...
class ContractTermination(Base):
    ...
    contract_id = mapped_column(
        "contract_id", TEXT, primary_key=True
    )
...
class ContractImproperExecution(Base):
    ...
    contract_id = mapped_column(
        "contract_id", TEXT, nullable=True
    )
...
class NotificationInfo(Base):
    ...
    procedure_id = mapped_column(
        "procedure_id", TEXT, primary_key=True
    )
...
class Complaint(Base):
    ...
    procedure_id = mapped_column(
        "procedure_id", TEXT, nullable=True
    )
...
class ParticipiantStat(Base):
    ...
    supplier_id = mapped_column(
        "supplier_id", VARCHAR(15), primary_key=True
    )
...
class Rnp(Base):
    __tablename__ = "rnp"
    supplier_inn = mapped_column(
        "supplier_inn", VARCHAR(15), primary_key=True
    )
    supplier_kpp = mapped_column("supplier_kpp", VARCHAR(9), nullable=True)
...
class MspRoster(Base):
    ...
    organization_type = mapped_column(
        "organization_type", CHAR(1), nullable=True
    )
    organization_category = mapped_column("organization_category", CHAR(1), nullable=True)
